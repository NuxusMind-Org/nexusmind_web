...
export const PsychologistPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col font-sans text-white" style={{ background: 'linear-gradient(260.37deg, #263151 -4.41%, #245D68 51.97%, #914899 100%)' }}>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-[350px] xl:w-[400px] flex flex-col gap-6">
            ...
            <div className="bg-[#2D3E50]/60 backdrop-blur-xl rounded-[24px] p-6 sm:p-8 border border-white/10 shadow-xl flex flex-col">
              ...
              <button className="w-full py-4 bg-[#c084fc] hover:bg-[#a855f7] text-[#1e1b4b] font-light text-[16px] rounded-xl transition-colors shadow-lg">
                Seans Təyin Et
              </button>
