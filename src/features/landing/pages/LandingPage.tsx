  ...
  useEffect(() => {
    ...
    const updateMascotPosition = () => {
      ...
      if (targetCardIndex !== activeCardIndexRef.current) {
        ...
        // Reveal arrows synchronously at zone-crossing time — before the
        // setTimeout fires — so they fade in while Nexie is still invisible.
        setArrowsVisible({
          a1: targetCardIndex >= 2,
          a2: targetCardIndex >= 3,
        });

        // Swap position while the wrapper is fully invisible (120ms).
        // src also changes here — but since opacity is 0, user never sees it.
        setTimeout(() => {
    ...
    <div className="h-screen w-full bg-gradient-to-br from-[#8a4fff]/20 via-[#1E293B] to-[#1E293B] flex flex-col relative font-sans">
      ...
      <main className="flex-1 w-full overflow-y-auto overscroll-y-none scroll-smooth no-scrollbar relative">
        ...
        <div className={`w-full relative flex flex-col transition-opacity duration-700 ease-in-out ${activeScreen === 'landing' ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
              ...
              <div className="relative w-[1056px] h-[417px] bg-white/10 backdrop-blur-xl border border-white/10 rounded-[8px] pt-[14px] pr-[21px] pb-[14px] pl-[21px] gap-[8px] flex flex-col justify-between items-center text-center shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                ...
                <div className="flex-1 flex flex-col justify-center gap-6 py-2 w-full items-center">
                  <div className="flex flex-col gap-3">
                    <h1 className="text-[32px] sm:text-[40px] md:text-[48px] font-bold text-white tracking-tight leading-tight">
                      Özünü kəşf etməyə hazırsan?
                    </h1>
                    <p className="text-[18px] sm:text-[22px] md:text-[24px] text-white/80 max-w-[800px] mx-auto leading-relaxed">
                  ...
                  <button
                    ...
                    className="w-[280px] bg-[#591b98] hover:bg-[#6c22b5] text-white py-3.5 rounded-full text-[16px] sm:text-[18px] font-semibold transition-all duration-300 shadow-[0_0_20px_rgba(89,27,152,0.4)] hover:shadow-[0_0_30px_rgba(89,27,152,0.6)] hover:scale-[1.02] cursor-pointer"
                  >
                    İndi başla
                  </button>
                </div>

                <p className="text-white/50 text-[12px] pb-2">
          ...
          <section
            id="features"
            className="relative w-full min-h-screen flex flex-col items-center justify-center px-[72px] pt-0 pb-20"
          >
            <ScrollReveal className="w-full mx-auto flex flex-col items-center">
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[8px] p-8 pb-[17px] flex flex-col overflow-hidden relative shadow-lg">
                ...
                {/* Top Right Card */}
                <div className="bg-[#2A7B9B] border border-white/10 rounded-[8px] p-8 flex flex-col relative shadow-lg">
                ...
                {/* Bottom Left Card */}
                <div className="bg-[#276F8C] border border-white/10 rounded-[8px] p-8 flex flex-col relative shadow-lg">
                  <div className="flex items-center gap-3 mb-6">
                ...
                <div className="md:col-span-2 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[8px] p-8 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-6 relative shadow-lg">
          ...
          <section
            id="pillars"
            className="relative w-full min-h-screen flex flex-col items-center justify-center px-[72px] py-20"
          >
            <ScrollReveal className="w-full mx-auto flex flex-col md:flex-row items-stretch gap-12 lg:gap-20">
              {/* Left Image (Pillars) */}
              <div className="w-full md:w-[582px] h-[400px] md:h-[728px] flex-shrink-0 rounded-[48px] overflow-hidden shadow-2xl relative">
          ...
          >
            <ScrollReveal className="w-full max-w-[1100px] mx-auto flex flex-col items-center">
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Card 1 */}
                <div className="bg-white rounded-[8px] p-8 sm:p-10 flex flex-col shadow-xl border border-transparent min-h-[300px]">
          ...
          >
            <div className="w-full max-w-[1100px] mx-auto flex flex-col">
              ...
              {/* Roadmap Boxes */}
              <div ref={roadmapRef} className="w-full max-w-[1100px] mx-auto relative flex flex-col gap-[240px] pb-[200px]">
                ...
                {/* Box 1 */}
                <ScrollReveal ref={card1Ref} className="w-[581px] h-[345px] relative">
                  <div className="w-full h-full bg-[#155567] rounded-[8px] p-10 relative shadow-2xl">
                ...
                {/* Box 2 */}
                <ScrollReveal ref={card2Ref} className="w-[581px] h-[345px] self-end relative">
                  <div className="w-full h-full bg-[#7B4B8B] rounded-[8px] p-10 relative shadow-2xl">
                    <h3 className="text-white text-[26px] font-bold mb-4 flex items-center gap-4">
                ...
                {/* Box 3 */}
                <ScrollReveal ref={card3Ref} className="w-[581px] h-[345px] relative">
                  <div className="w-full h-full bg-[#155567] rounded-[8px] p-10 relative shadow-2xl">
                    <h3 className="text-white text-[26px] font-bold mb-4 flex items-center gap-4">
            ...
            <div className="w-screen -mx-[72px] bg-white/5 py-8 border-y border-white/10 overflow-hidden relative mt-20">
              <style>{`
                @keyframes ticker {
          ...
          <section
            ...
            className="relative w-full min-h-screen flex flex-col items-center justify-center px-[72px] py-20"
          >
            <ScrollReveal className="w-full max-w-[1200px] h-[75vh] mx-auto relative rounded-[8px] overflow-hidden shadow-[0_30px_70px_rgba(0,0,0,0.5)] border border-white/20 group">
              {/* Background Image */}
              <img
                src={vrConsultation}
                alt="VR Consultation"
              ...
              <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 md:right-10 bg-[#eeb3b3]/30 backdrop-blur-2xl border border-white/40 rounded-[20px] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                <div className="flex-1">
          ...
          <section
            id="cta"
            className="relative w-full flex flex-col items-center px-[72px] pt-[112px] pb-0"
          >
            <ScrollReveal className="w-full md:w-[898px] h-auto md:h-[354px] mx-auto bg-white/20 backdrop-blur-md rounded-[8px] pt-[14px] pr-[21px] pb-[14px] pl-[21px] gap-[8px] flex flex-col items-center justify-center text-center shadow-2xl border border-white/10 rotate-0 opacity-100">
              <h2 className="text-[36px] sm:text-[44px] font-bold text-white tracking-tight">
                İndi qoşul !
              </h2>
              <p className="text-[16px] sm:text-[18px] text-white/90 max-w-[700px] mb-2">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-[#0b2430] rounded-full px-8 py-4 sm:py-5 text-white text-[16px] placeholder-white/50 focus:outline-none border border-transparent focus:border-[#a88bff]/50 transition-colors shadow-inner"
                  required
                />
                <button
                  type="submit"
                  className="bg-[#a88bff] hover:bg-[#9773fc] text-[#1a2b3c] font-bold text-[16px] sm:text-[18px] rounded-full px-10 py-4 sm:py-5 transition-all duration-300 shadow-[0_4px_14px_rgba(168,139,255,0.4)] hover:shadow-[0_6px_20px_rgba(168,139,255,0.6)] cursor-pointer"
                >
                  Göndər
                </button>
              </form>
          ...
          <section
            id="experts"
            className="relative w-full min-h-screen flex flex-col items-center pt-[112px]"
          >
            <ScrollReveal className="w-full max-w-[1200px] mx-auto flex flex-col items-center pb-20 px-[72px]">
