    ...
    <div className="w-full flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 pb-6 border-b border-white/10 relative z-30">
      ...
      <div className="flex items-center gap-3 self-end md:self-auto" ref={dropdownRef}>
        ...
        <div className="relative">
          ...
          <div
            className={`absolute right-0 top-full mt-2 w-full min-w-[200px] transition-all duration-300 transform z-50 ${
              isSortOpen
            ...
            <div className="glass-card rounded-lg p-2 flex flex-col gap-0.5 shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
              {(Object.keys(SORT_LABELS) as NewsSortOption[]).map((option) => (
                <button
                  ...
                  className={`w-full text-left py-2.5 px-3 rounded-lg text-[13px] font-medium transition-colors cursor-pointer bg-transparent border-0 outline-none ${
                    activeSort === option
