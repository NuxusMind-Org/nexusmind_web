...
export const ExpertsSection = () => {
  ...
  return (
    <section
      id="experts"
      className="relative w-full min-h-0 md:min-h-screen flex flex-col items-center pt-8 md:pt-14 scroll-mt-20"
    >
      <div className="w-full max-w-[1200px] mx-auto flex flex-col items-center pb-20 px-4 sm:px-8 md:px-12 lg:px-[72px]">
        <ScrollReveal className="w-full text-center mb-6 sm:mb-10">
